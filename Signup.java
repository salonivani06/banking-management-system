...
public class Signup extends JFrame implements ActionListener {
  ...
  JDateChooser dateChooser; // isse hum date ko add kr skte h to isme file to load krege
  Random ran = new Random();// to generate random number in application form
  ...
  Signup() {
    ...
    labelG.setFont(new Font("Raleway1", Font.BOLD, 20));
    ...
    ButtonGroup buttonGroup = new ButtonGroup(); // these were used for radiobutton koi ek select hoga
    buttonGroup.add(r1);
    buttonGroup.add(r2);// grp krdiya dono buttonko
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    // next button pr click hoga
    // niche 3 line h jisse hum data lekr store kr rehe h calender esa nhi hoga
    ...
    try {
      if (textName.getText().equals("")) {
        ...
        new Signup2(formno); // first is random form no
        setVisible(false);
